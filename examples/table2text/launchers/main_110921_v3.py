...
python -m table2text.launchers.main_110921_v3 --test_run False
bash table2text/scripts/main_110921_v3.sh
...
def main(
    out_path="./table2text/scripts/main_110921_v3.sh",
    seeds=(0, 1, 2),
