...
- [BartForConditionalGeneration](https://huggingface.co/docs/transformers/model_doc/bart#transformers.BartForConditionalGeneration) (only when positional embedding layers in encoder and decoder are not updated!)
